...
def build_index():
    ...
    # Unter 160 Zeichen — sonst schneidet Google das Ende im Suchergebnis ab.
    desc = (f"Humanoiden Roboter Unitree G1 für Event, Messe und Konferenz mieten. Ganzer Tag ab "
            f"{PRICE_MIN} — Operator und Branding inklusive, keine Anzahlung, Angebot in 24 h.")
...
def build_offer_pages(write):
    ...
    write(de("oferta.html"), simple_page(
        ...
        "Das Angebot von 33bots: humanoide Roboter für Messen, Konferenzen, Galas und "
        "Firmenfeiern. Operator deutschlandweit inklusive →",
...
""" + text_section(
    ...
    return simple_page(
        ...
        "Videos aus echten Einsätzen des Unitree G1: Begrüßung, Tanzshow, Interaktion und "
        "Branding. Sehen Sie, wie es bei Ihrem Event aussehen kann →",
...
def build_case_studies(write):
    cases = [
        ...
        ("case-study-women-in-tech.html", "Case Study: Women in Tech Summit",
         "Case Study Women in Tech Summit — 14 000 Gäste | 33bots",
