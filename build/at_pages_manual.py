...
def build_index():
    ...
    cities = _("at_cities").CITIES

    title = "Humanoide Roboter für Events mieten — österreichweit | 33bots"
    ...
    kw = ("humanoide roboter mieten, roboter mieten event, roboter für messe mieten, Unitree G1 mieten, "
          "roboter konferenz, event attraktion roboter, humanoider roboter Österreich")
    ...
    faqs = [
        ...
        ("Ist die Vermietung österreichweit verfügbar?",
         "Ja — 33bots ist in ganz Österreich im Einsatz, unabhängig von Stadt und "
         "Entfernung. Wir bedienen Wien, Graz, Linz, Salzburg, Innsbruck, Klagenfurt, St. Pölten und Dutzende "
         "weitere Städte."),
    ...
    ld.append(json.dumps({
        ...
        "description": "Vermietung humanoider Roboter Unitree G1 für Events, Konferenzen und Messen in ganz Österreich.",
    ...
    ld.append(json.dumps({
        ...
        "description": "Vermietung humanoider Roboter Unitree G1 für Events, Konferenzen und Messen in ganz "
                       "Österreich. Mit zertifiziertem Operator vor Ort.",
        "email": EMAIL,
        "areaServed": {"@type": "Country", "name": "Österreich"},
        ...
        "contactPoint": {"@type": "ContactPoint", "email": EMAIL,
                         "contactType": "sales", "areaServed": "AT",
    ...
    ld.append(json.dumps({
        ...
        "alternateName": "33bots — humanoide Roboter mieten", "url": f"{DOMAIN}/", "inLanguage": "de-AT",
        "description": "Humanoide Roboter Unitree G1 für Events, Messen und Konferenzen in ganz Österreich mieten.",
    ...
    city_chips = "\n".join(
        f'        <a href="{at(f)}" class="tile__link" style="padding:8px 16px; background:var(--surface-2); '
        f'border:1px solid var(--border-mid); border-radius:8px;">{d["name"]}</a>'
        for f, d in cities.items())
    coverage = "\n".join(f'            <li><a href="{at(f)}">{d["name"]}</a></li>' for f, d in cities.items())

    return f"""<!DOCTYPE html>
<html lang="de-AT">
<head>
{_("gtm_head")()}
{_("head_common")(title, desc, kw, "index.html", "og-image.jpg", "Humanoider Roboter Unitree G1 — Miete für Events in Österreich")}
...
{_("mobile_menu")("")}
  ...
  <section class="hero">
    <div class="hero__content">
      <p class="hero__eyebrow">Humanoide Roboter mieten · Österreichweit · Bestpreis</p>
    ...
    <div class="hero__visual">
      ...
      <div class="hero__robot">
        ...
        <picture>
          ...
          <img src="robot-g1.jpg" alt="Humanoider Roboter Unitree G1 — Attraktion für Events, Messen und Konferenzen in Österreich" class="hero__robot-img" width="600" height="800" loading="eager" fetchpriority="high" />
        </picture>
      </div>
      </div>
  ...
  <div class="stats-bar">
    <div class="stats-bar__inner">
      <div class="stat-item"><span class="stat-item__val" data-count="35" data-suffix="+">0</span><span class="stat-item__lbl">Städte in Österreich</span></div>
...
{_("gallery_section")(lead="Keine Renderings, keine Studioaufnahmen: Galas, Summits, Straßenaktionen, Outdoor-Events und Nachtshows — Bilder aus Veranstaltungen, die wir tatsächlich betreut haben.")}
  ...
  <section class="section" id="referenzen" style="padding-top:var(--s8); padding-bottom:var(--s8);">
    <div style="max-width:1000px; margin:0 auto; text-align:center;">
      ...
      <div style="display:flex; flex-wrap:wrap; align-items:stretch; justify-content:center; gap:var(--s4);">
        <a href="{at('case-study-women-in-tech.html')}" style="display:flex; flex-direction:column; gap:4px; padding:var(--s4) var(--s6); background:var(--surface-2); border:1px solid var(--border-mid); border-radius:12px; text-decoration:none; min-width:220px; text-align:left;">
        ...
        <a href="{at('case-study-lexai.html')}" style="display:flex; flex-direction:column; gap:4px; padding:var(--s4) var(--s6); background:var(--surface-2); border:1px solid var(--border-mid); border-radius:12px; text-decoration:none; min-width:220px; text-align:left;">
      ...
      <div style="display:flex; gap:var(--s5); justify-content:center; flex-wrap:wrap; margin-top:var(--s4);">
        <a href="{at('case-study-lexai.html')}" style="display:inline-flex; color:var(--text); font-size:0.9rem; font-weight:600; text-decoration:underline; text-underline-offset:3px;">Case Study LEX AI →</a>
        <a href="{at('case-study-wallstreet.html')}" style="display:inline-flex; color:var(--text); font-size:0.9rem; font-weight:600; text-decoration:underline; text-underline-offset:3px;">Case Study WallStreet 30 →</a>
        <a href="{at('realizacje-wideo.html')}" style="display:inline-flex; color:var(--text); font-size:0.9rem; font-weight:600; text-decoration:underline; text-underline-offset:3px;">Alle Referenzvideos →</a>
      </div>
    </div>
  </section>
  ...
  <section class="section tiles-section" id="leistungen">
    ...
    <div class="tiles">
      <div class="tile">
        ...
        <p class="tile__desc">Sie wollen, dass über Ihre Veranstaltung gesprochen wird? Der G1 kommt zu Ihrer Konferenz, Eröffnung oder Gala — und sorgt garantiert für Andrang. <a href="{at('robot-na-impreze.html')}" style="color:inherit; text-decoration:underline;">Roboter für Ihre Feier →</a></p>
  ...
  <section class="section onas-section" id="ueber-uns">
    ...
    <div class="onas-body">
      <div class="onas-text">
        <p class="lead-text">33bots ist auf die <a href="{at('wypozyczenie-robota.html')}" style="color:var(--text); text-decoration:underline; text-underline-offset:3px;">Vermietung humanoider Roboter Unitree G1</a> für Events, Messen und Technologie-Shows spezialisiert. Das ist unser einziges Geschäft — wir sind keine Agentur, die alles ein bisschen macht.</p>
        <p class="body-text">Die Miete eines humanoiden Roboters bei 33bots bedeutet immer Rundum-Betreuung: Wir bringen den Roboter zu Ihnen, stellen einen Operator für die gesamte Veranstaltungsdauer und kümmern uns um alles — vom Aufbau bis zur finalen Show. Wir sind in Wien, Graz, Linz, Salzburg, Innsbruck, Klagenfurt, St. Pölten und in jeder weiteren österreichischen Stadt im Einsatz.</p>
        <p class="body-text">Sehen Sie sich unsere spezialisierten Angebote an: <a href="{at('oferta-targi.html')}" style="color:var(--text); text-decoration:underline; text-underline-offset:3px;">Roboter für Messen und Ausstellungen</a> sowie <a href="{at('oferta-konferencje.html')}" style="color:var(--text); text-decoration:underline; text-underline-offset:3px;">Roboter für Konferenzen und Galas</a>.</p>
      </div>
      <ul class="onas-usps">
        ...
        <li>Einsätze in jeder österreichischen Stadt</li>
    ...
    <div class="transport-callout">
      ...
      <div class="transport-callout__left">
        ...
        <p class="transport-callout__claim"><em>Österreichweit</em><br />im<br />Einsatz.</p>
      </div>
      <div class="transport-callout__right">
        <p class="transport-callout__note">Wir bringen den Roboter zu jeder Veranstaltung — von Wien bis Bregenz, von Linz bis Klagenfurt. Anfahrt und Logistik planen wir vorab und halten sie im Angebot fest.</p>
        <ul class="transport-callout__stats">
          <li><strong>30–45 Min</strong><span>bis einsatzbereit</span></li>
          <li><strong>100 %</strong><span>Österreich abgedeckt</span></li>
  ...
  <section class="section" id="video">
    ...
    <div style="display:flex; flex-wrap:wrap; gap:var(--s6); align-items:center; justify-content:center; max-width:1000px; margin:0 auto;">
      ...
      <div style="max-width:420px; display:flex; flex-direction:column; gap:var(--s4); text-align:left;">
        ...
        <a href="{at('realizacje-wideo.html')}" style="display:inline-flex; align-items:center; gap:8px; color:var(--text); font-size:0.9rem; font-weight:600; text-decoration:underline; text-underline-offset:3px;">Mehr Aufnahmen aus Einsätzen →</a>
        <a href="#kontakt" class="btn-primary" style="display:inline-flex; align-self:flex-start;">Show reservieren →</a>
      </div>
    </div>
  </section>
    ...
    <div class="pricing-grid">
      <article class="price-card price-card--main">
        ...
        <ul class="price-card__list">
          ...
          <li>Anfahrt österreichweit — Logistik nach Absprache</li>
...
{_("TESTIMONIALS")}
  ...
  <section class="section" id="einsatzbereiche">
    ...
    <div class="use-grid">
      <div class="use-item"><span class="use-num">01</span><h3>Konferenzen &amp; Summits</h3><p>Der Roboter als Gastgeber, Guide oder Attraktion am Registration Desk.</p><a href="{at('oferta-konferencje.html')}" class="tile__link" style="margin-top:var(--s2);display:inline-flex;">Konferenz-Angebot →</a></div>
      <div class="use-item"><span class="use-num">02</span><h3>Messen &amp; Ausstellungen</h3><p>Ziehen Sie zehnmal mehr Aufmerksamkeit an den Stand als mit jedem Banner.</p><a href="{at('oferta-targi.html')}" class="tile__link" style="margin-top:var(--s2);display:inline-flex;">Mehr erfahren →</a></div>
      <div class="use-item"><span class="use-num">03</span><h3>Firmenfeiern &amp; Hochzeiten</h3><p>Sommerfeste, Jubiläen, Galas, Hochzeiten — Gesprächsstoff weit über den Abend hinaus.</p><a href="{at('robot-na-wesele.html')}" class="tile__link" style="margin-top:var(--s2);display:inline-flex;">Roboter zur Hochzeit →</a></div>
      <div class="use-item"><span class="use-num">04</span><h3>Tage der offenen Tür &amp; Bildung</h3><p>Schulen, Hochschulen, Science Center — Technologie, die die Welt verändert.</p><a href="{at('oferta-dni-otwarte.html')}" class="tile__link" style="margin-top:var(--s2);display:inline-flex;">Mehr erfahren →</a></div>
...
{_("blog_cards")(4)}
    ...
    <div style="text-align:center; margin:0 0 var(--s10);">
      <a href="{at('blog.html')}" class="btn-ghost" style="display:inline-flex;">Alle Artikel ansehen →</a>
    </div>
      ...
      <div class="contact-left">
        ...
        <div class="contact-details" itemscope itemtype="https://schema.org/ProfessionalService">
          ...
          <div class="contact-detail">
            ...
            <span class="contact-detail__val" itemprop="areaServed">Österreichweit</span>
          </div>
        </div>
...
{coverage}
          ...
          <p class="coverage__note">und überall sonst in Österreich</p>
        </nav>
      </div>
      <div class="contact-right">
{_("contact_form")("z. B. Wien, Messe Halle B")}
      </div>
    </div>
  </section>
...
def build(gen_globals):
    ...
    import at_blog
    G["blog_cards"] = at_blog.make_cards(G)
    ...
    if not _("ANALYTICS"):
        return legal_block(
            ...
            ["Diese Website setzt ausschließlich technisch notwendige Cookies ein, die für ihren Betrieb "
             "erforderlich sind. Sie sind nach § 165 Abs. 3 TKG 2021 von der Einwilligungspflicht "
             "ausgenommen.",
    ...
    return "\n".join([
        legal_block("4. Cookies und Einwilligung",
                    ["Wir setzen technisch notwendige Cookies ein, die für den Betrieb der Website erforderlich "
                     "sind; sie sind nach § 165 Abs. 3 TKG 2021 einwilligungsfrei.",
                     "Alle weiteren Dienste — insbesondere die unten genannten Analyse-Dienste — setzen wir "
                     "ausschließlich nach Ihrer ausdrücklichen Einwilligung ein (§ 165 Abs. 3 TKG 2021, Art. 6 Abs. 1 "
...
def build_legal_pages(write):
    ...
    imp = "\n".join([
        legal_block("Angaben gemäß § 5 ECG",
                    [f"Diensteanbieter: {C('legal_name')}",
                     f"Anschrift: {address}",
                     f"Vertretungsberechtigte Person: {C('represented_by')}",
                     f"Registereintrag: {C('register')}",
                     f"Umsatzsteuer-Identifikationsnummer (UID): {C('vat_id')}",
                     "Unternehmensgegenstand: Vermietung humanoider Roboter für Veranstaltungen, "
                     "Messen und Konferenzen samt Betreuung durch einen Operator."]),
        legal_block("Kontakt",
        ...
        legal_block("Offenlegung gemäß § 25 MedienG",
                    [f"Medieninhaber, Herausgeber und für den Inhalt verantwortlich: {C('content_responsible')}",
                     f"Grundlegende Richtung (Blattlinie): {C('media_direction')}"]),
        legal_block("Verbraucherstreitbeilegung",
                    ["Wir sind nicht verpflichtet und nicht bereit, an Streitbeilegungsverfahren vor einer "
                     "Verbraucherschlichtungsstelle teilzunehmen. Unsere Leistungen richten sich an "
                     "Unternehmen und Veranstalter.",
                     "Verbraucherinnen und Verbraucher können sich in Österreich an die Internet Ombudsstelle "
                     "(ombudsstelle.at) wenden. Die EU-Plattform zur Online-Streitbeilegung (ODR) wurde am "
                     "20. Juli 2025 eingestellt und steht nicht mehr zur Verfügung."]),
        ...
        legal_block("Urheberrecht",
                    ["Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem "
                     "österreichischen Urheberrecht. Beiträge Dritter sind als solche gekennzeichnet."]),
        editorial_note("Die gelb markierten Felder müssen vor der Veröffentlichung mit den tatsächlichen "
                       "Unternehmensdaten befüllt werden. Ein fehlendes oder unvollständiges Impressum ist in "
                       "Österreich verwaltungsstrafbewehrt (§ 26 ECG, § 27 MedienG)."),
    ])
    write("impressum.html", legal_page(
        "impressum.html", "Impressum", "Impressum | 33bots",
        "Impressum von 33bots — Anbieterkennzeichnung gemäß § 5 ECG und Offenlegung nach § 25 MedienG.",
        "Impressum.", "Anbieterkennzeichnung gemäß § 5 E-Commerce-Gesetz (ECG) und Offenlegung nach § 25 Mediengesetz.", imp))
    ...
    # ── Barrierefreiheitserklärung (BaFG) ─────────────────────────────
    bf = "\n".join([
        legal_block("Unser Anspruch",
                    ["Wir möchten, dass diese Website von möglichst allen Menschen genutzt werden kann — "
                     ...
                     "Stufe AA sowie die Anforderungen des österreichischen Barrierefreiheitsgesetzes (BaFG), "
                     "das seit 28. Juni 2025 in Kraft ist."]),
        ...
        legal_block("Feedback und Kontakt",
                    [f"Ihnen sind Barrieren aufgefallen oder Sie benötigen Informationen in einem anderen Format? "
                     ...
                     f"text-decoration:underline; text-underline-offset:3px;\">{EMAIL}</a>. "
        ...
        legal_block("Durchsetzungsverfahren",
                    [f"Wenn Sie mit unserer Antwort nicht zufrieden sind, können Sie sich an die zuständige "
                     f"Marktüberwachungsbehörde wenden: {C('market_surveillance')}"]),
        editorial_note("Ob das BaFG für Ihr Angebot verbindlich gilt, hängt von Unternehmensgröße und Art der "
    ...
    write("barrierefreiheit.html", legal_page(
        ...
        "Erklärung zur Barrierefreiheit dieser Website nach BaFG — umgesetzte Maßnahmen, bekannte "
...
def build_offer_pages(write):
    ...
    write(at("oferta.html"), simple_page(
        at("oferta.html"), "Leistungen & Angebot",
    ...
    # oferta-targi.html
    write(at("oferta-targi.html"), simple_page(
        at("oferta-targi.html"), "Messen & Ausstellungen",
        ...
        "zertifiziertem Operator, österreichweit im Einsatz →",
    ...
    write(at("oferta-konferencje.html"), simple_page(
        at("oferta-konferencje.html"), "Konferenzen & Galas",
        ...
        "mit zertifiziertem Operator, österreichweit im Einsatz →",
    ...
    write(at("oferta-dni-otwarte.html"), simple_page(
        at("oferta-dni-otwarte.html"), "Tage der offenen Tür",
    ...
    write(at("wypozyczenie-robota.html"), simple_page(
        at("wypozyczenie-robota.html"), "Humanoiden Roboter mieten",
        ...
        "Roboter mieten · Österreichweit · Ganzer Showtag",
    ...
    write(at("robot-na-wesele.html"), simple_page(
        at("robot-na-wesele.html"), "Roboter zur Hochzeit",
    ...
    write(at("robot-na-impreze.html"), simple_page(
        at("robot-na-impreze.html"), "Roboter für Ihre Feier",
    ...
    write(at("realizacje-wideo.html"), build_referenzen())


def build_referenzen():
    DOMAIN = _("DOMAIN")
    VIDEOS = _("VIDEOS")
    out_file = at("realizacje-wideo.html")
...
{chr(10).join(f'        <a href="{at(o)}" style="color:var(--text); font-size:0.85rem; font-weight:600; padding:8px 16px; background:var(--surface-2); border:1px solid var(--border-mid); border-radius:10px; text-decoration:none;">{c}</a>' for o, c, *_rest in cases if o != pl_file)}
        <a href="{at('realizacje-wideo.html')}" style="color:var(--text); font-size:0.85rem; font-weight:600; padding:8px 16px; background:var(--surface-2); border:1px solid var(--border-mid); border-radius:10px; text-decoration:none;">Alle Referenzvideos</a>
      </div>
    </div>
  </section>
"""
        write(at(pl_file), simple_page(
            at(pl_file), crumb, title, desc, kw, eyebrow, h1, sub, sections,
            kontakt_h2="Ähnliches Ergebnis<br />für Ihr Event?", schema_type="Article"))

    # szablon-case-study.html → vorlage-case-study.html
    write(at("szablon-case-study.html"), simple_page(
        at("szablon-case-study.html"), "Vorlage: Case Study",
    ...
    _index_redesign_html = simple_page(
        at("index-redesign.html"), "Startseite (Entwurf)",
    ...
    write(at("index-redesign.html"), _index_redesign_html)
