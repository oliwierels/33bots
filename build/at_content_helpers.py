...
def faq_transport():
    return ("Kommen Sie auch in unsere Stadt?",
            "Ja — wir sind österreichweit im Einsatz. Wir bedienen sowohl Großstädte als auch kleinere "
...
DESCS = [
    ...
    "Unitree G1 {na}: begrüßt Gäste, tanzt, posiert für Fotos und spricht dank KI — österreichweit "
...
EYEBROWS = [
    "Roboter mieten · Event-Attraktion · Österreichweit",
    "Humanoider Roboter · Unitree G1 · Show mit Operator",
    "Premium-Attraktion · Unitree G1 · Österreichweit",
    "Humanoider Roboter mieten · Österreichweit im Einsatz",
    "Unitree G1 · Showact mit Operator · Österreichweit",
