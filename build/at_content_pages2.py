...
from at_content_helpers import ev, br, priv, DOG_PRICE, PRICE_FROM
...
EVENTS = [
    ...
    ev("robot-na-roadshow", "Roboter für Roadshows", "für Roadshows", "Auf einer Roadshow",
       sub="Eine Roadshow lebt vom wiederholbaren Effekt in jeder Stadt der Route. Der humanoide Roboter ist die Attraktion, die in Wien genauso stark wirkt wie in Innsbruck — und die Logistik übernehmen wir.",
       uniq_tile=("Route", "Ganz Österreich in einem Projekt", "Wir planen die Präsenz des Roboters auf der gesamten Route: Termine, Transport, dasselbe Team und derselbe Showstandard in jeder Stadt. Sie haben einen Ansprechpartner für die gesamte Route."),
...
PRIVATE = [
    ...
    priv("robot-na-bal-maturalny", "Roboter für den Maturaball", "für den Maturaball", "Auf einem Maturaball",
         sub="Ein Maturaball mit humanoidem Roboter ist die Veranstaltung, die in die Schulgeschichte eingeht. Der G1 eröffnet den Ball, tanzt mit dem Abschlussjahrgang und posiert für Fotos, die noch in derselben Nacht Instagram fluten.",
    ...
    priv("robot-na-karnawal", "Roboter für den Fasching", "für den Fasching", "Auf einer Faschingsfeier",
         sub="Ein Faschingsball braucht einen Star der Tanzfläche — und niemand tanzt so wie ein humanoider Roboter. Der G1 führt Tanzshows auf, reiht sich in den Faschingsumzug ein und posiert für Fotos in Faschingskulisse.",
