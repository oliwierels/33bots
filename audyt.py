# -*- coding: utf-8 -*-
"""Audyt techniczny witryny statycznej — kryteria z raportu SETPROFIT dla 33bots.pl.

Sprawdza to, co da się sprawdzić z plików w repozytorium: duplikaty tytułów, długości
meta, H1, canonical, noindex, thin content, alt, wagę grafik na stronę, nagłówki
bezpieczeństwa w .htaccess, przekierowanie /index.html, spójność sitemapy i hreflang.

Użycie:  python3 audyt.py <katalog> <domena>
"""
